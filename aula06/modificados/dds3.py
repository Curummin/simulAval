...
dados = []
with open("./modificados/dados3.txt", "r") as arq:
    for linha in arq:
        linha = linha.strip()
        if linha:
...
# =========================
print("\n===== RESUMO =====")
print(f"Quantidade total de dados3.txt: {n}")
...
Frequencias observadas: [202, 176, 190, 227, 205]
Frequencia esperada em cada classe: 200.0
Estatistica qui-quadrado calculada: 7.1700
Valor critico (alpha1 =0.1): 7.7794
Valor critico (alpha2 =0.05): 9.4877
Valor critico (alpha3 =0.01): 13.2767

Resultado (alpha1 = 0.1): Nao se rejeita H0

Resultado (alpha2 = 0.05): Nao se rejeita H0

Resultado (alpha3 = 0.01): Nao se rejeita H0
...
===== RESUMO =====
Quantidade total de dados3.txt: 1000
Qui-quadrado calculado: 7.1700
Graus de liberdade: 4

===== TESTE QUI-QUADRADO =====
Alpha     Chi2 Critico        Decisão
0.1       7.7794              Não rejeita H0
0.05      9.4877              Não rejeita H0
0.01      13.2767             Não rejeita H0

1. Nenhuma saida a hipotese nula é rejeitada
2. Após executar para ambos conjuntos, temos que dados2.txt tem maior chi2
3. Os dados são compativeis com a distribuição uniforme
4. Não ha evidencias o suficiente para rejeitar h0
'''